...
import { OnboardingFieldRow } from "./onboarding-field-row";
...
export function SortableOnboardingFields({
  fields,
  onFieldsChange,
  ...
  onFieldsChange: (next: OnboardingField[]) => void;
  onPaletteDropAtIndex: (e: DragEvent, dropIndex: number, isFieldType: (v: string) => v is OnboardingFieldType) => void;
  onPaletteDropAppend: (e: DragEvent, isFieldType: (v: string) => v is OnboardingFieldType) => void;
  isFieldType: (v: string) => v is OnboardingFieldType;
}) {
